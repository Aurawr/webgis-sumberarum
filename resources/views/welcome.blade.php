...
<<<<<<< HEAD
    <header
        class="fixed top-0 left-0 right-0 z-50 pt-4 px-6 md:px-12 lg:px-16"
        id="main-header">
        <div class="transition-all duration-500 ease-in-out rounded-full max-w-7xl mx-auto border-2" id="navbar-bg">
            <div class="flex justify-between items-center w-full px-6 md:px-8 lg:px-10 h-16 md:h-18">
                <!-- Logo Section -->
                <div class="flex items-center gap-3 hover:opacity-80 transition-opacity duration-300 cursor-pointer">
                    <span class="material-symbols-outlined text-primary dark:text-tertiary-fixed text-3xl">map</span>
                    <div class="flex flex-col">
                        <span
                            class="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-primary dark:text-on-primary-fixed leading-tight text-[20px] md:text-[24px] font-bold">Desa
                            Sumberarum</span>
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    <a class="relative px-4 py-2 text-[15px] font-semibold text-secondary dark:text-secondary-fixed hover:text-secondary dark:hover:text-secondary-fixed transition-all duration-300 group"
                        href="#profil">
                    ...
                    <a class="relative px-4 py-2 text-[15px] font-medium text-primary/80 dark:text-on-primary-fixed/80 hover:text-secondary dark:hover:text-secondary-fixed transition-all duration-300 group"
                        href="{{ url('/infografis') }}">
        ...
        <div class="lg:hidden fixed inset-0 top-20 bg-white/95 dark:bg-primary/95 backdrop-blur-xl transform -translate-x-full transition-transform duration-300 ease-in-out"
            ...
            <nav class="flex flex-col p-6 gap-1">
                <a class="px-4 py-4 text-[16px] font-semibold text-secondary dark:text-secondary-fixed hover:bg-secondary/10 dark:hover:bg-secondary-fixed/10 rounded-lg transition-all duration-200"
                    href="#profil">
                    Profil Desa
                </a>
                <a class="px-4 py-4 text-[16px] font-medium text-primary/80 dark:text-on-primary-fixed/80 hover:text-secondary dark:hover:text-secondary-fixed hover:bg-secondary/10 dark:hover:bg-secondary-fixed/10 rounded-lg transition-all duration-200"
                    href="{{ url('/infografis') }}">
                    Infografis
                </a>
                <a class="px-4 py-4 text-[16px] font-medium text-primary/80 dark:text-on-primary-fixed/80 hover:text-secondary dark:hover:text-secondary-fixed hover:bg-secondary/10 dark:hover:bg-secondary-fixed/10 rounded-lg transition-all duration-200"
...
=======
<x-navbar />
>>>>>>> 96f0b7d0f785ead9ac435eed0dd3c9401d568a1a
